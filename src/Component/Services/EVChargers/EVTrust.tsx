...
const EVTrust = () => {
  const deliveries = [
    { title: 'Licensed EV Installers', desc: 'Our certified electricians handle every EV charger installation safely and to Australian standards.', icon: Hammer, gradient: 'from-orange-400 to-orange-500' },
    { title: 'Premium Charger Brands', desc: 'We supply and install only high-performance EV chargers from globally trusted manufacturers.', icon: ShieldCheck, gradient: 'from-blue-500 to-cyan-400' },
    { title: 'Solar Ready Systems', desc: 'Every charger we install is designed to integrate seamlessly with your existing or future solar system.', icon: Zap, gradient: 'from-purple-500 to-pink-500' },
  ];
