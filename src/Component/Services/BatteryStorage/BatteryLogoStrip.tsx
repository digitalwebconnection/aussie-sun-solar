...
const BatteryLogoStrip = () => {
  const logos = [
    ...
    { name: "Alpha ESS", url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQnVUMoSUmeEvFN2DTi-ZyBeHYbPlboc40YsQ&s" },
...
export default BatteryLogoStrip;
