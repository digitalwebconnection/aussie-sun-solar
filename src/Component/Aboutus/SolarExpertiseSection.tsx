  ...
  const locations = [
    {
      ...
      description: "Smart rooftop solar systems designed to reduce electricity bills and power modern homes efficiently.",
      points: [
    ...
    },
    {
      ...
      description: "Advanced solar energy systems for offices, showrooms, warehouses, and commercial buildings.",
      points: [
        "Reduce Operational Costs",
        "Custom Solar EPC Solutions",
    ...
    },
    {
      ...
      description: "Scalable industrial solar installations built for factories and large-scale energy consumption.",
      points: [
        "Mega Watt Solar Installations",
