...
const CommercialHero = () => {
  ...
  return (
    <section id="commercialsolar-hero" aria-label="CommercialSolar Hero Banner" className="relative overflow-hidden pt-28 pb-8">
      <div className="absolute inset-0">
        <img
          src={commercialSolar1}
          alt="Commercial solar panel installation background"
