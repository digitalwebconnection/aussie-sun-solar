...
const BatteryWhyChoose = () => {
  ...
  return (
    <section id="batterystorage-why-choose" aria-label="Why Choose BatteryStorage" className="py-14 bg-white relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-10 md:mt-20">
          {[['5K+', 'Batteries Installed'], ['2500+', 'Happy Customers'], ['10 Years', 'Warranty'], ['5-Star', 'Reviews']].map((item, i) => (
            <motion.div key={i} initial={{ opacity: 0, scale: 0.9 }} whileInView={{ opacity: 1, scale: 1 }} viewport={{ once: true }} transition={{ delay: 0.3 + i * 0.1 }} className="bg-[#F8FAFC] border border-gray-200 rounded-lg p-8 text-center shadow-black/50 shadow-lg hover:shadow-xl transition-all duration-500">
