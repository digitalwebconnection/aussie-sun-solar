...
import { Sun, Battery, Zap, Home, ArrowRight, ShieldCheck } from 'lucide-react';

const BatteryProcess = () => {
  const steps = [
    { id: '01', title: 'Solar Energy Captured', desc: 'Your solar panels collect sunlight and generate clean electricity throughout the day.', icon: Sun, color: 'from-amber-400 to-orange-500', glow: 'shadow-orange-500/20' },
    { id: '02', title: 'Energy Stored In Battery', desc: 'Excess solar power is stored in your battery system instead of being fed back to the grid.', icon: Battery, color: 'from-blue-400 to-indigo-600', glow: 'shadow-blue-500/20' },
    { id: '03', title: 'Smart Energy Management', desc: 'An intelligent system manages when to store, use, or export energy for maximum savings.', icon: Zap, color: 'from-emerald-400 to-teal-600', glow: 'shadow-emerald-500/20' },
    { id: '04', title: 'Power On Demand', desc: 'Use stored energy at night or during outages — full independence from the grid.', icon: Home, color: 'from-purple-400 to-pink-600', glow: 'shadow-purple-500/20' },
  ];

  const rightContent = [
    { title: 'Backup Power Protection', subtitle: 'Always On', value: '24/7', desc: 'Your battery keeps essential appliances running even during grid blackouts.', color: 'from-orange-400 to-yellow-500' },
    { title: 'Reduce Grid Dependency', subtitle: 'Energy Freedom', value: '90%', desc: 'Households with battery storage reduce grid electricity usage by up to 90%.', color: 'from-emerald-400 to-teal-500' },
    { title: 'Maximise Solar Savings', subtitle: 'Bill Reduction', value: '80%', desc: 'Store and use your own solar energy to dramatically cut electricity bills.', color: 'from-blue-400 to-indigo-500' },
    { title: 'Zero Emissions Living', subtitle: 'Clean Energy', value: '0 CO₂', desc: 'Pair battery storage with solar for a completely clean energy household.', color: 'from-purple-400 to-pink-500' },
  ];
      ...
      <div className="max-w-7xl mx-auto  px-6 relative z-10">
        <motion.div variants={itemVariants} className="mb-12 text-center">
          ...
          <h2 className="text-3xl md:text-5xl font-serif font-bold text-white leading-tight mb-6 flex flex-col items-center">
            <BlurText text="Smart Battery Storage" delay={80} animateBy="words" direction="top" />
            <BlurText text="Solutions for Your Home" delay={60} animateBy="words" direction="bottom" className="text-transparent bg-clip-text bg-linear-to-r from-[#FE9900] to-orange-400" />
          </h2>
