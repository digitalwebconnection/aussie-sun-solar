...
const BlogMain = () => {
  return (
    <>
      <Helmet>
        {/* Title */}
        <title>Solar Energy Insights & Blog | ass Energy</title>
        ...
        {/* Canonical */}
        <link rel="canonical" href="https://ass.in/Knowledge/" />

        {/* Open Graph */}
        <meta property="og:title" content="Solar Energy Blog | ass Energy Insights" />
        ...
        <meta property="og:url" content="https://ass.in/Knowledge/" />
        <meta property="og:type" content="website" />

        {/* OG Image */}
        <meta property="og:image" content="https://ass.in/solar-blog.jpg" />
